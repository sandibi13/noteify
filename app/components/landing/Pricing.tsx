import {
  HighlighterItem,
  HighlightGroup,
} from "~/components/landing/Highlighter";
...
const tiers = [
  {
    ...
    features: ["50 Notes", "Basic AI Assistance"],
    cta: "Get Started for Free",
  },
  {
    name: "Pro",
    price: 15,
    description: "Ideal for growing teams and advanced users",
    features: ["500 Notes", "Advanced AI Assistance"],
    cta: "Try Pro for 14 days",
  },
  {
    name: "Enterprise",
    price: 30,
    description: "Tailored for businesses with extensive needs",
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            ...
            <p className="text-lg text-zinc-400">
              Invite your team and boost productivity with AI-powered notes.
            </p>
          </div>
          {/* Pricing tabs */}
                ...
                <div className="relative h-full bg-zinc-900 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="p-8">
                      ...
                      <p className="mt-4 text-sm leading-6 text-zinc-400">
                        Enhance teamwork with shared notes and AI assistance.
                      </p>
                      <div className="mt-16 ">
                        <Link
